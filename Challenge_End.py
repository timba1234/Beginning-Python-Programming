...
if intA != intC:
    print("intA is NOT equal to intC")

# 3. Create an if-statement that asks "if intA is greater than or equal to intC"
# then print the following message if the condition evaluates to True:
# "intA is greater than or equal to intC"

if intA >= intC:
    print("intA is greater than or equal to intC")
...
if intA <= intC:
    print("intA is less than or equal to intC")
